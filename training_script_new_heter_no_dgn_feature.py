...
def get_args():
    ...
    parser.add_argument('--save_dir', type=str, default='new_heter_results_no_dgn_feature', help='Base directory for saving information.')
...
for layers in range(1, 6):
    ...
    filename = f'new_heter_results_no_dgn_feature/{args.dataset}.csv'
